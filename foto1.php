...
<title>İstanbul Şehir Üniversitesi-Fotoğraflar Sayfası</title>
</head>
...
echo '<div style="height:100px; width:auto; margin:auto; position:absolute; right:15%;top:60%;"><br><br><br><br><br>';

    echo '<div style="height: 50%; width: auto; float: left; font-size: 20px;"><img src="images/m7.jpg"><br><br><br><br></div>';
