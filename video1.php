...
<title>İstanbul Şehir Üniversitesi-Videolar Sayfası</title>
</head>
...
echo '<div style="height:100px; width:auto; margin:auto; position:absolute; left:5%;top:60%;"><br><br><br><br><br>';

    echo '<div style="height: 50%; width: auto; float: right; font-size: 20px;"><iframe width="560" height="315" src="https://www.youtube.com/embed/qnmfD0gPR5g" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
	echo'</div>';
    ?>
    
    <?php
	echo '<div style="float:left; width:50%; position:absolute; right:2%;top:60%;">';
...
if(isset($_POST['kullanici']) && isset($_POST['mesaj'])) {
   ...
   if(empty($kullanici) || empty($mesaj)) {
      ...
      echo 'Lütfen formu boş bırakmayın';
	   ...
	   if ($_POST) {  echo '<br><br><br><br><br><br>';
...
?>
<div style="float:right;width:50%; position:absolute; right:5%;top:60%;">
